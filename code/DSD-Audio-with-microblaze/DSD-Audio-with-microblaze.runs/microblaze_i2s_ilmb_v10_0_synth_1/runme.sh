...
HD_PWD='C:/DSD/Labos_2022/DSD-project/code/DSD-Audio-with-microblaze/DSD-Audio-with-microblaze.runs/microblaze_i2s_ilmb_v10_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log microblaze_i2s_ilmb_v10_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source microblaze_i2s_ilmb_v10_0.tcl
