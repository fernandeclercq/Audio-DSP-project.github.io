...
#
# Generated by export_simulation on Thu Dec 01 15:06:12 +0100 2022
#
################################################################################
...
'-reset_run' switch to the './microblaze_i2s.sh' script.

./microblaze_i2s.sh -reset_run
...
./microblaze_i2s.sh -noclean_files

For more information on the script, please type './microblaze_i2s.sh -help'.
