...
HD_PWD='C:/DSD/Labos_2022/DSD-project/code/DSD_audio/DSD_audio.runs/i2s_receiver_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log i2s_receiver_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source i2s_receiver_0.tcl
