...
#
# Generated by export_simulation on Thu Dec 01 15:37:49 +0100 2022
#
################################################################################
...
'-reset_run' switch to the './i2s_receiver_0.sh' script.

./i2s_receiver_0.sh -reset_run
...
./i2s_receiver_0.sh -noclean_files

For more information on the script, please type './i2s_receiver_0.sh -help'.
