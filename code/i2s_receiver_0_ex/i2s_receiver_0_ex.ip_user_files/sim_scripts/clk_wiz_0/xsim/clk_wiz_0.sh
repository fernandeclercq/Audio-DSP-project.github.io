...
#
# Generated by Vivado on Thu Dec 01 15:37:53 +0100 2022
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xpm -L unisims_ver -L unimacro_ver -L secureip --snapshot clk_wiz_0 xil_defaultlib.clk_wiz_0 xil_defaultlib.glbl -log elaborate.log
}
