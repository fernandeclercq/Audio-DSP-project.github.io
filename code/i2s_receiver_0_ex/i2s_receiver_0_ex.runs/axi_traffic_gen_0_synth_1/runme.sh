...
HD_PWD='c:/DSD/Labos_2022/DSD-project/code/i2s_receiver_0_ex/i2s_receiver_0_ex.runs/axi_traffic_gen_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_traffic_gen_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axi_traffic_gen_0.tcl
