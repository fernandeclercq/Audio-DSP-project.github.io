...
HD_PWD='c:/DSD/Labos_2022/DSD-project/code/i2s_receiver_0_ex/i2s_receiver_0_ex.runs/i2s_transmitter_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log i2s_transmitter_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source i2s_transmitter_1.tcl
